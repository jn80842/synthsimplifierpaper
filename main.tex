...
%%% by Julie Newcomb, Andrew Adams, Steven Johnson, Rastislav Bodik, and Shoaib Kamil.
%%%
\setcopyright{rightsretained}
\acmPrice{}
\acmDOI{10.1145/3428234}
\acmYear{2020}
\copyrightyear{2020}
\acmSubmissionID{oopsla20main-p148-p}
\acmJournal{PACMPL}
\acmVolume{4}
\acmNumber{OOPSLA}
\acmArticle{166}
...
\keywords{term rewriting system, verification, synthesis}  %% \keywords are mandatory in final camera-ready submission
...
and showing this ruleset lowers peak memory usage of compiled code with nearly
